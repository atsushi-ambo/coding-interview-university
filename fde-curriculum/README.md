...
and a checklist — like [Coding Interview University](../README.md), check items off as you go.
...
plus solid CS fundamentals (see [Coding Interview University](../README.md) for the deep version)
